...
if ($id != "") {
	...
	$checkRound_sql = "SELECT MAX(track_round) as r FROM report_follow WHERE data_id = '$id' and division = '$userS_locate'";
	$checkRound_query = mysqli_query($conn, $checkRound_sql);
